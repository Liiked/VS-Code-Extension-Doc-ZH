...
本文档采用了全新的 vitepress 架构，大幅更新了文档中过时的部分，修复了大量资源链接也同时补充了大量内容，但是依旧保留了本项目的特色术语提示和原文档链接。在 AI 时代下，本文档依旧提供给学有余力的“人”。作为系统性文档，它在这个时代依旧能够指导人去处理 AI 编程犯的错误，同时也能让你更好地理解 VS Code 插件开发模式。本次改版中也采用了大量 AI 翻译辅助，不过还是由译者校审，翻译过程依旧可能存在错误情况，望读者不吝指教。
...
- **参与**：本项目会采取较为严格的翻译审查，若你有热情一同学习和贡献自己的力量，请参考我们的[开发和翻译指南](https://github.com/Liiked/VS-Code-Extension-Doc-ZH)。
...
- [Contribution Points](https://code.visualstudio.com/docs/extensionAPI/overview) 配置点：package.json的一部分，用于配置插件启动命令、用户可更改的插件配置，可以理解为插件的主要配置文件。
